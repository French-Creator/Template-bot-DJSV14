...
axios.get('https://api.github.com/repos/CorwinDev/Discord-Bot/releases/latest').then(res => {
    ...
    console.log(chalk.red.bgYellow(`Impossible de vérifier si le robot est à jour!`));
});
...
manager.on('shardCreate', shard => {
    ...
    shard.on("shardDisconnect", (event) => {
        const embed = new Discord.EmbedBuilder()
            ...
            .setDescription("Événement de fermeture de socket de dumping...")
            .setColor(config.colors.normal)
        shardLogs.send({
            username: 'Bot Logs',
            embeds: [embed],
